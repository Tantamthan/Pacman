...
BLINKY_START: tuple[int, int, int] = (56, 58, RIGHT)
INKY_START: tuple[int, int, int] = (440, 388, UP)
PINKY_START: tuple[int, int, int] = (440, 438, UP)
CLYDE_START: tuple[int, int, int] = (470, 438, UP)
...
TURN_WINDOW_MIN: int = 12
TURN_WINDOW_MAX: int = 18
FONT_SIZE: int = 20
